<div class="row hidden-xs hidden-sm menu-nav">
  <div id="header" class="col-md-10 col-md-offset-1" style="border:#4682B4 solid 4px;border-top:none;border-radius:0px 0px 5px 5px;padding-bottom:10px;padding-top:10px;">
    <div id="titre-div">
    ...
    <div class="col-md-10 col-md-offset-2" style="margin-top:10px;">
      <nav class="navbar navbar-default" style="border:#2a9fd6 solid 4px;background:rgba(136,136,136,0.7)">
        <ul class="nav navbar-nav pull-right">
          ...
          <li style="font-family:TrueLies;font-size:2em;" class="navigation-champ"><a style="color:#000;font-weight:bold" href="chat.php"><i class="fa fa-comment-o"></i> Chiraq-Chat </a></li>
